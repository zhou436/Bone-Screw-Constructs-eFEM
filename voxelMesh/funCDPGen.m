...
MAT.comp.epsilonF = 0.1;    % compression failure (deletion) strain [-]
...
MAT.tens.epsilonF = 0.05;    % compression failure (deletion) strain [-]
%
EL = MAT.EL;
...
plot(MAT.comp.CDPtable(:,1),MAT.comp.CDPtable(:,2));
